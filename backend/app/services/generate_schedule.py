...
def gerar_programacao(db: Session) -> dict:
    ...
    # Definição do intervalo da semana para a trava de duplicidade
    ...
    for cliente in clientes:
        ...
        # --- FILTRO: NÃO GERAR SE TIVER "Por solicitação" NA OBSERVAÇÃO ---
        if cliente.observacao and "Por solicitação" in cliente.observacao:
            ignorados += 1
            continue
        ...
        # --- TRAVA CONTRA DUPLICIDADE (POR SEMANA) ---
        # Verifica se já existe QUALQUER agendamento para este cliente 
        #